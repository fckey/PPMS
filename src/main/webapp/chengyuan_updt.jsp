...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="输入账号" style="width:150px;" data-rule-required="true" data-msg-required="请填写账号" remote="checkno.do?checktype=update&id=${mmm.id}&table=chengyuan&col=zhanghao" data-msg-remote="内容重复了" id="zhanghao" name="zhanghao" value="${Info.html(mmm.zhanghao)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_xingbie6" data-value="${Info.html(mmm.xingbie)}" data-rule-required="true" data-msg-required="请填写性别" id="xingbie" name="xingbie" style="width:250px">
<option value="男">男</option>
<option value="女">女</option>

</select>
<script>
$(".class_xingbie6").val($(".class_xingbie6").attr("data-value"))</script>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="text" class="form-control" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',lang:'zh-cn'})" style="width:120px;" data-rule-required="true" data-msg-required="请填写生日" id="shengri" name="shengri" readonly="readonly" value="${Info.html(mmm.shengri)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="输入年龄" style="width:150px;" data-rule-required="true" data-msg-required="请填写年龄" number="true" data-msg-number="输入一个有效数字" id="nianling" name="nianling" value="${Info.html(mmm.nianling)}"/>                                            
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_xiangmu7" data-value="${Info.html(mmm.xiangmu)}" id="xiangmu" name="xiangmu" style="width:250px">
...
<script>
$(".class_xiangmu7").val($(".class_xiangmu7").attr("data-value"))</script>
