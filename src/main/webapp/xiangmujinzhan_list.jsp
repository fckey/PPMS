...
<div class="panel panel-default">
    ...
    是否已完成
                            ...
                            <select class="form-control class_shifouyiwancheng14" data-value="${param.shifouyiwancheng}" data-rule-required="true" data-msg-required="请填写是否已完成" id="shifouyiwancheng" name="shifouyiwancheng">
<option value="">请选择</option><option value="否">否</option>
<option value="是">是</option>

</select>
<script>
$(".class_shifouyiwancheng14").val($(".class_shifouyiwancheng14").attr("data-value"))</script>
