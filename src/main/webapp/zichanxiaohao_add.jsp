...
<div class="container"><!-- 使用bootstrap css框架，container定宽，并剧中 https://v3.bootcss.com/css/#overview-container -->
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="zichanxiaohaoinsert.do" method="post" name="form1" id="form1"><!-- form 标签开始 -->
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <select class="form-control class_xiangmu18" data-value="" id="xiangmu" name="xiangmu" style="width:250px">
...
<option value="${m.xiangmumingcheng}">${m.xiangmumingcheng}</option>
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
                                                    ...
                                                    <input type="number" class="form-control" placeholder="输入消耗数量" style="width:150px;" data-rule-required="true" data-msg-required="请填写消耗数量" number="true" data-msg-number="输入一个有效数字" id="xiaohaoshuliang" name="xiaohaoshuliang" value=""/>                                            
        </div>
