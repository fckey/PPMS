        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="chengyuaninsert.do" method="post" name="form1" id="form1"><!-- form 标签开始 -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control" placeholder="输入账号" style="width:150px;"
                                       ...
                                       remote="checkno.do?checktype=insert&table=chengyuan&col=zhanghao"
                    ...
                    <div class="form-group">
                        <div class="row">
                            <label style="text-align: right" class="col-sm-2 hiddex-xs">密码<span
                                    style="color: red;">*</span></label>
                            <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select class="form-control class_xingbie2" data-value="" data-rule-required="true"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="number" class="form-control" placeholder="输入年龄" style="width:150px;"
                                       ...
                                       data-msg-number="输入一个有效数字" id="nianling" name="nianling" value=""/>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control" placeholder="输入电话" style="width:150px;"
                                       ...
                                       data-msg-phone="请输入正确手机号码" id="dianhua" name="dianhua" value=""/>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <select class="form-control class_xiangmu3" data-value="" id="xiangmu" name="xiangmu"
                                        style="width:250px">
                                    <ssm:sql var="select"
